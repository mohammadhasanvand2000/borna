...
(function ($) {
  ...
  (function () {
    if ($("#flotBars1").get(0)) {
      var plot = $.plot("#flotBars1", [flotBarsData1], {
        colors: ["#8CC9E8"],
        series: {
          bars: {
            show: true,
        ...
        yaxis: {
          tickFormatter: (num)=> Number(num).toLocaleString()
        },
        grid: {
          hoverable: true,
          clickable: true,
  ...
  (function () {
    if ($("#ChartistLineScatterDiagramWithResponsiveSettings").get(0)) {
      ...
      new Chartist.Line(
        "#ChartistLineScatterDiagramWithResponsiveSettings",
        data,
        options,
        responsiveOptions
      );
  ...
  (function () {
    if ($("#ChartistLineChartWithTooltips").get(0)) {
      new Chartist.Line(
        "#ChartistLineChartWithTooltips",
        chartWithTooltipData,
        {
          axisY: {
      ...
      $chart.on("mouseenter", ".ct-point", function () {
        var $point = $(this),
          value = Number($point.attr("ct:value")).toLocaleString(),
  ...
  (function () {
    if ($("#ChartistBiPolarLineChartWithAreaOnly").get(0)) {
      new Chartist.Line(
        "#ChartistBiPolarLineChartWithAreaOnly",
        {
          labels: [1, 2, 3, 4, 5, 6, 7, 8],
          series: [
            [1, 2, 3, 1, -2, 0, 1, 0],
  ...
  (function () {
    if ($("#ChartistLineInterpolationSmoothing").get(0)) {
      var chart = new Chartist.Line(
        "#ChartistLineInterpolationSmoothing",
        {
          labels: [1, 2, 3, 4, 5],
          series: [
            [1, 5, 10, 0, 1, 2],
  ...
  (function () {
    if ($("#ChartistOverlappingBarsOnMobile").get(0)) {
      ...
      new Chartist.Bar(
        "#ChartistOverlappingBarsOnMobile",
        data,
        options,
        responsiveOptions
      );
  ...
  (function () {
    if ($("#ChartistAddPeakCirclesUsingDrawEvents").get(0)) {
      ...
      var chart = new Chartist.Bar(
        "#ChartistAddPeakCirclesUsingDrawEvents",
        {
          labels: ["W1", "W2", "W3", "W4", "W5", "W6", "W7", "W8", "W9", "W10"],
          series: [[1, 2, 4, 8, 6, -2, -1, -4, -6, -2]],
        },
  ...
  (function () {
    if ($("#ChartistPieChartWithCustomLabels").get(0)) {
      ...
      new Chartist.Pie(
        "#ChartistPieChartWithCustomLabels",
        data,
        options,
        responsiveOptions
      );
